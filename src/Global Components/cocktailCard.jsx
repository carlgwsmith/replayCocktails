...
export default function CocktailCard(props) {
  ...
  return (
    <>
      <div className="grid grid-cols-6 mb-10 bg-white p-4 rounded-md border border-red-100">
        <div className="col-span-6 text-center text-gunmetal">
          <h2 className="text-[24px] font-bold mt-4">{props.name}</h2>
        </div>
        <div className="col-span-6 text-center text-gunmetal">
          <div className="cockCardImage">
            ...
            >
              ...
              <img
                src={props.img}
                style={{ height: "324px", width: "161px" }}
              />
              {/* </div> */}
            </Carousel>
          </div>
      ...
      >
        ...
        <button onClick={closeModal} className="float-right text-white mt-10">
          close
        </button>
      </Modal>
    </>
